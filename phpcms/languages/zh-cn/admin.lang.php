...
$LANG['setting_phpsso_type'] = '请填写接口地址，格式为：http://www.baidu.cn,结尾不包含“/”';
...
$LANG['meta_title'] = '（栏目标题）';
$LANG['meta_keywords'] = '（栏目关键词）';
$LANG['meta_description'] = '（栏目描述）';
