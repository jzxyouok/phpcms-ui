...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#tablename").formValidator({
            ...
            type: "get",
            url: "",
            data: "m=content&c=sitemodel&a=public_check_tablename",
            datatype: "html",
            async: 'false',
    ...
    <div class="admin-content-body">
        <div class="am-cf am-padding am-padding-bottom-0">
            <div class="am-fl am-cf">
                <strong class="am-text-primary am-text-lg"><?php echo L('add_model') ?></strong> /
                <small>add_model</small>
            </div>
        </div>
        <hr>
        <div class="am-g">
            <div class="am-u-sm-12">
                <div class="pad-lr-10">
                    <form action="?m=content&c=sitemodel&a=add" method="post" id="myform">
                        <fieldset>
                            ...
                            <table width="100%" class="table_form">
                                <tr>
                                    ...
                                    <td class="y-bg"><input type="text" class="input-text" name="info[name]" id="name"
                                                            size="30"/></td>
                                </tr>
                                <tr>
                                    <th><?php echo L('model_tablename') ?>：</th>
                                    <td class="y-bg"><input type="text" class="input-text" name="info[tablename]"
                                                            id="tablename" size="30"/></td>
                                </tr>
                                <tr>
                                    <th><?php echo L('description') ?>：</th>
                                    <td class="y-bg"><input type="text" class="input-text" name="info[description]"
                                                            id="description" size="30"/></td>
                                </tr>
                            </table>
                        </fieldset>
                        <div class="bk15"></div>
                        ...
                        <div class="bk15"></div>
                        <fieldset>
                            <legend><?php echo L('other_template_setting') ?> <input type="checkbox" id="other"
                                                                                     value="1" name="other"></legend>
