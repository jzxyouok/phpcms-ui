...
<div class="pad_10">
<form action="?m=admin&c=copyfrom&a=edit" method="post" class="am-form" name="myform" id="myform" >
<table width="100%" cellpadding="2" cellspacing="1" class="am-table am-table-striped am-table-hover table-main">
	<tr>
